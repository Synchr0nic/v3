...
export function Sidebar() {
  ...
  return (
    <div 
      className="w-20 hover:w-64 bg-zinc-900/80 backdrop-blur-sm border-r border-zinc-800 min-h-[calc(100vh-4rem)] p-4 sticky top-16 transition-all duration-300"
      style={{
    ...
    >
      ...
      >
        ...
        <span className="font-light tracking-wider hidden group-hover:block whitespace-nowrap transition-all duration-300">
          NEW PROJECT
        </span>
      </Link>
